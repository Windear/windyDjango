...
class DesignWorks(models.Model):
    """
    设计详情表
    1.编号id
    2.标题
    ...
    def upload_path_handler(instance, file_name):
        ...
        filename = DesignWorks.change_name(file_name)
    ...
    class Meta:
        db_table = 'designWorks'
        verbose_name = "我的设计"  # 单数数据表可读名称
        verbose_name_plural = "我的设计"  # 复数数据表可读名称
